module.exports = function (test, backwards) {
	var f = backwards.isFunction;
	
	test('backwards.isFunction should be a function', function (t) {
	...
	test('it should return true if passed a Function', function (t) {
		t.equal(f( new Function() ), true);
		t.equal(f( function () {} ), true);
		t.end();
	});
