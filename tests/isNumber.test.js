module.exports = function (test, backwards) {
	var f = backwards.isNumber;
	
	test('backwards.isNumber should be a function', function (t) {
	...
	test('it should return true if passed a Number', function (t) {
		t.equal(f( new Number() ), true);
		t.equal(f( 1234 ), true);
		t.end();
	});
