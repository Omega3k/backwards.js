module.exports = function (test, backwards) {
	var f = backwards.isUndefined;
	
	test('backwards.isUndefined should be a function', function (t) {
	...
	test('it should return true if passed an Undefined', function (t) {
		t.equal(f( undefined ), true);
		t.end();
	});
};