module.exports = function (test, backwards) {
	var f = backwards.isObject;
	
	test('backwards.isObject should be a function', function (t) {
	...
	test('it should return true if passed an Object', function (t) {
		t.equal(f( new Object() ), true);
		t.equal(f( {} ), true);
		t.end();
	});
