module.exports = function (test, backwards) {
	var f = backwards.isBoolean;
	
	test('backwards.isBoolean should be a function', function (t) {
	...
	test('it should return true if passed a Boolean', function (t) {
		t.equal(f( false ), true);
		t.end();
	});
